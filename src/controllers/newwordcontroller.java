...
public class newwordcontroller implements ActionListener,MouseMotionListener,MouseListener {

	private static newwordcontroller _newwordcontrol;
	...
	public newwordcontroller(JFrame _frmadd,JButton _btnbold,JButton _btnitalic,JButton _btnclose,Panel _panel,JTextField _txtword,JButton _btnsubscript,JButton _btnsuper,JComboBox _cbotypelst,JEditorPane _txtdesc,JButton _btnadd,JButton _btncancel){
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==btnadd){
				...
				String temp=	txtdesc.getText().replaceAll("'", "");
					...
					Boolean b=dal.InsertWord(o, tblname);
	...
	public void mouseDragged(MouseEvent e) {
		...
		Point tpoint = frmadd.getLocation();
		frmadd.setLocation(tpoint.x + e.getX() - point.x, tpoint.y + e.getY() - point.y );
	}
	@Override
